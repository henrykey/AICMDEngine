...
```json
{
  "render": "...markdown...",
  "rag": {
    "page_text": "...verbatim body text (not summary)...",
    "elements": [
      {
        "id": "p14_t1",
        "type": "table",
...
- Table as Markdown/HTML for render; semantic meaning for rag elements.
- Illustration in render must be represented as placeholder with textual description.
